...
class _SeichiMapPageState extends State<SeichiMapPage>
  ...
  Future<void> _loadStamps() async {
    ...
    final saved =
        _preferences!.getStringList('collected_seichi_ids') ?? <String>[];
    _collectedIds
      ..clear()
      ..addAll(saved);
  }
    ...
    return Stack(
      children: [
        ...
        if (_errorMessage != null)
          Positioned(left: 16, right: 16, bottom: 135, child: _errorCard()),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        remaining == 0 ? '完全制覇！' : 'あと $remaining 札',
                        style: const TextStyle(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: Center(child: _stampVisual(card, item, collected)),
              ),
              Text(
                collected ? item!.name : '？？？',
                maxLines: 2,
                ...
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  color: collected ? Colors.black87 : Colors.grey.shade500,
                ),
              ),
              const SizedBox(height: 4),
              Text(
                collected ? item!.reading : '聖地を訪れて獲得',
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
                style: TextStyle(
                  fontSize: 10,
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              fontSize: 32,
              color: collected ? null : Colors.grey.shade500,
            ),
          ),
          Text(
          ...
          children: [
            ...
            if (next != null)
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: const LinearGradient(
                    colors: [Color(0xFF24123D), Color(0xFF6A35C8)],
                  ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Text(next.icon, style: const TextStyle(fontSize: 45)),
                        const SizedBox(width: 14),
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
              ...
              _simpleCard('🏆', '完全制覇！', 'すべての聖地を獲得しました。'),
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            const Text(
              '※オンラインランキング連携時にはSupabaseのユーザーランキングへ置き換え可能です。',
  ...
  Widget _rankRow(String medal, int rank, String name, int count) {
    return Container(
      ...
      child: Row(
        children: [
          Text(medal, style: const TextStyle(fontSize: 25)),
          const SizedBox(width: 12),
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const CircleAvatar(
              radius: 47,
              backgroundColor: Color(0xFF6A35C8),
...
class SonarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 3; i++) {
      ...
      paint.color = Colors.deepPurple.withOpacity(
        (1 - phase) * .45 * intensity + .05,
      );
