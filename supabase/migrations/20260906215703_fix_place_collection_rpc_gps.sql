-- ============================================================
-- record_place_visit_and_collect GPS fact fix
-- ============================================================
--
-- 修正内容:
--   collection_history の latitude / longitude を
--   RPC呼び出し時の入力値ではなく、
--   保存済み place_visits の訪問事実から取得する。
--
-- 既存の 20260908000000_place_collection_rpc.sql は
-- すでに適用済みのため変更せず、この migration で
-- CREATE OR REPLACE FUNCTION を行う。
-- ============================================================
