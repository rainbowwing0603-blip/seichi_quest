drop function public.get_my_collection_history();
create function public.get_my_collection_history()
returns table(event_id uuid,event_name text,content_id uuid,card text,event_content_id uuid,place_id uuid,content_key text,collected_at timestamptz)
...
alter table public.collection_history drop column seichi_id;;
